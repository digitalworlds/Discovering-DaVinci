  ...
  <div class="draw-card-modal">
    ...
    <transition name="modal-slideUp">
      <div class="modal-wrapper" v-show="beginAnimation">
        <div class="header">DRAW NEW CARD</div>
        <div class="content">
          <div class="top-text">
            ...
            400 Coins to draw a random trivia card?
          </div>
          <div
            class="top-text"
            style="margin-top: 0"
          >Answer the trivia question correctly to gain a random Invention Piece!</div>
          <ul class="flex-container row">
            <li class="flex-item">
              <picture class="invention-piece">
                <img class="invention-piece" src="../../assets/ItemIcon_RandomIP.png" />
              </picture>
            </li>
            <li class="flex-item">
          ...
          <div class="opt-out" @click="onCheckboxClick()">
            <input v-model="settings.modals.drawCard" type="checkbox" id="optOut" value="optOut" />
...
.modal-wrapper {
  ...
  background: url("../../assets/Modal_Frame_Large_001.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
  margin: auto;
  right: 0;
