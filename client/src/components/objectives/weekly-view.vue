<template>
  <div class="weekly-container" ref="needsScrolling">
    <objective-card
      v-for="(objective_key, index) in Object.keys(this.objectives.weekly)"
      :key="index"
      :title="objective_key"
      :objective="objectives.weekly[objective_key]"
...
.grid-wrapper {
  ...
  grid-gap: 10px;
  grid-auto-rows: minmax(97px, 97px);
